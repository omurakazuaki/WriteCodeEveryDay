...
- 🥇 Highest record: **45** days
- 😊 Latest record: **45** days ( **55** days to reach 🎉**100** days anniversary )
...
4 🍺<br>[oauth: wip](./rust/oauth)|5 🍺<br>[oauth: session](./rust/oauth)|6 🍺<br>[oauth device flow](./rust/oauth-device)|7 🍺<br>[OpenID Connect: wip](./rust/oidc)|8<br>-|9<br>-|10<br>-
